...
#define  At                                        "At"
#define  I_ll_meet                                 "I' ll meet"
#define  zeus_is_the_leader_of_the_gods            "Zeus is the leader of the gods and god of the sky and thunder in Greek mythology." 
#define  OK                                        "OK" 
#define  Cancel                                    "Cancel"
#define  meeting_plan_                             "Meeting Plan"
